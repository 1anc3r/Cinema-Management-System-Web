...
public class SettingUI extends JPanel {
	...
	protected void initContent() {
		...
		JButton btnUser = new JButton("查看个人资料");
		btnUser.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		...
		JButton btnEdit = new JButton("修改个人资料");
		...
		JButton btnHelp = new JButton("关于/帮助");
		btnHelp.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		...
		JButton btnSwitch = new JButton("切换账号");
		btnSwitch.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		btnSwitch.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "哎呀一不小心被我注释掉了!");
			}
	...
	class UsrDialog extends JDialog {
		...
		UsrDialog(int flag) {
			...
			if (flag == 1) {
				...
				lblAccess1 = new JLabel("权限 : ");
				lblAccess1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblAccess1.setBounds(80, 30, 60, 30);
				pan.add(lblAccess1);
				lblAccess2 = new JLabel("");
				lblAccess2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblAccess2.setBounds(140, 30, 240, 30);
				pan.add(lblAccess2);

				lblNo1 = new JLabel("工号 : ");
				lblNo1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblNo1.setBounds(80, 65, 60, 30);
				pan.add(lblNo1);
				lblNo2 = new JLabel("");
				lblNo2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblNo2.setBounds(140, 65, 240, 30);
				pan.add(lblNo2);

				lblName1 = new JLabel("名字 : ");
				lblName1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblName1.setBounds(80, 100, 60, 30);
				pan.add(lblName1);
				lblName2 = new JLabel("");
				lblName2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblName2.setBounds(140, 100, 240, 30);
				pan.add(lblName2);

				lblAddr1 = new JLabel("地址 : ");
				lblAddr1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblAddr1.setBounds(80, 135, 60, 30);
				pan.add(lblAddr1);
				lblAddr2 = new JLabel("");
				lblAddr2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblAddr2.setBounds(140, 135, 240, 30);
				pan.add(lblAddr2);

				lblTel1 = new JLabel("电话 : ");
				lblTel1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblTel1.setBounds(80, 170, 60, 30);
				pan.add(lblTel1);
				lblTel2 = new JLabel();
				lblTel2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblTel2.setBounds(140, 170, 240, 30);
				pan.add(lblTel2);

				lblEmail1 = new JLabel("邮箱 : ");
				lblEmail1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
				lblEmail1.setBounds(80, 205, 60, 30);
				pan.add(lblEmail1);
				lblEmail2 = new JLabel();
				lblEmail2.setFont(new Font("微软雅黑", Font.PLAIN, 16));
