...
public class SaleUI extends JPanel {
	...
	public void showTable() {
		...
		Object[] in = { "ID", "员工", "时间", "付款", "找零", "类型", "状态" };
	...
	class SaleDialog extends JDialog {
		...
		SaleDialog(final int flag) {
			...
			lblEmployee = new JLabel("员工");
			lblEmployee.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			lblEmployee.setBounds(80, 30, 60, 30);
			pan.add(lblEmployee);

			txtEmployee = new JTextField("");
			txtEmployee.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			txtEmployee.setBounds(140, 30, 120, 30);
			pan.add(txtEmployee);

			lblTime = new JLabel("时间");
			lblTime.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			...
			lblPayment = new JLabel("付款");
			lblPayment.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			lblPayment.setBounds(80, 100, 60, 30);
			pan.add(lblPayment);

			txtPayment = new JTextField("");
			txtPayment.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			txtPayment.setBounds(140, 100, 120, 30);
			pan.add(txtPayment);

			lblChange = new JLabel("找零");
			lblChange.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			lblChange.setBounds(80, 135, 60, 30);
			pan.add(lblChange);

			txtChange = new JTextField("");
			txtChange.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			...
			txtType.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			txtType.setBounds(140, 170, 120, 30);
			pan.add(txtType);

			lblStatus = new JLabel("状态");
			lblStatus.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			lblStatus.setBounds(80, 205, 60, 30);
			pan.add(lblStatus);

			txtStatus = new JTextField("");
			txtStatus.setFont(new Font("微软雅黑", Font.PLAIN, 16));
