...
public class StudioUI extends JPanel {
	...
	public void showTable() {
		...
		studTable.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		Object[] in = { "ID", "名字", "行数", "列数", "描述", "状态" };
	...
	class StudioDialog extends JDialog {
		...
		StudioDialog(final int flag) {
			...
			lblRow.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			...
			lblCol = new JLabel("列数 : ");
			lblCol.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			...
			lblIntroduction = new JLabel("描述 : ");
			lblIntroduction.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			...
			lblFlag = new JLabel("状态 : ");
			lblFlag.setFont(new Font("微软雅黑", Font.PLAIN, 16));
