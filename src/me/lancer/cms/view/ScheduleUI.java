...
public class ScheduleUI extends JPanel {
	...
	public static void showPanel() {
		JFrame frame = new JFrame("演出计划管理");
	...
	class ScheduleDialog extends JDialog {
		...
		ScheduleDialog(final int flag) {
			...
			lblStudio = new JLabel("演出厅");
			lblStudio.setFont(new Font("微软雅黑", Font.PLAIN, 16));
			...
			lblPlay = new JLabel("剧目 : ");
			lblPlay.setFont(new Font("微软雅黑", Font.PLAIN, 16));
