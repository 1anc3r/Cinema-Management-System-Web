...
<li><a href="sale_list.jsp" target="frame_right"><font color="#FEFEFE">订单列表</font></a></li>
<li><a href="sale_fetch.jsp" target="frame_right"><font color="#FEFEFE">查找订单</font></a></li>
<li><a href="sale_delete.jsp" target="frame_right"><font color="#FEFEFE">退还订单</font></a></li>
</ul>
</body>
</html>