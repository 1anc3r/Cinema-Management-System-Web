...
<li><a href="seat_list.jsp" target="frame_right"><font color="#FEFEFE">座位列表</font></a></li>
<li><a href="seat_modify.jsp" target="frame_right"><font color="#FEFEFE">修改座位</font></a></li>
</ul>
</body>
</html>